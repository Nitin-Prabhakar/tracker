...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">SS LAW ASSOCIATES</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
										<upload-form customheader="Automate a tracker" callback="upload"></upload-form>
                </div>
            </div>
        </div>
				<div class="container-fluid">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; Nitin Prabhakar 2016
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="vendor-theme/bootstrap/js/bootstrap.min.js"></script>
